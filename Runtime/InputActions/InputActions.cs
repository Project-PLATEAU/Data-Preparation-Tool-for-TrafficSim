...
//     version 1.7.0
//     from Packages/com.synesthesias.plateau-trafficsimulationtool/Runtime/InputActions/InputActions.inputactions
//
...
namespace TrafficSimulationTool.Runtime
{
    ...
    ""controlSchemes"": []
        ...
        {
            private @InputActions m_Wrapper;
            public ArrangeAssetActions(@InputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @InputActions m_Wrapper;
            public WalkerMoveActions(@InputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @InputActions m_Wrapper;
            public SelectCamPosActions(@InputActions wrapper) { m_Wrapper = wrapper; }
